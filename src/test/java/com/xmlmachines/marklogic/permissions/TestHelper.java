...
public class TestHelper {
	...
	public static String UNIT_TEST_APPSERVER_PORT = "8020";
	public static String XCC_FULL_ACCESS_USER_LOCALHOST = "xcc://full-user:password@localhost:"
			+ UNIT_TEST_APPSERVER_PORT;
	public static String XCC_EXECUTE_READ_USER_LOCALHOST = "xcc://execute-read-user:password@localhost:"
			+ UNIT_TEST_APPSERVER_PORT;

	public static String XCC_NOPERMS_USER_NOPERMS_PASS_LOCALHOST = "xcc://no-perms:password@localhost:"
			+ UNIT_TEST_APPSERVER_PORT;
	public static String XCC_ADMIN_ADMIN_LOCALHOST = "xcc://admin:admin@localhost:"
			+ UNIT_TEST_APPSERVER_PORT;
	...
	public static String FIRST_DOC_IN_DB_PERMISSIONS_QUERY = "element properties {xdmp:document-get-permissions(xdmp:node-uri(doc()[1]))}";
	...
	private static String ADD_REMAINING_PERMISSIONS_TO_REMAINING_DOCS = "for $doc in doc() return xdmp:document-set-permissions(xdmp:node-uri($doc), (xdmp:permission(\"insert-update-role\", \"update\"), xdmp:permission(\"execute-read-role\", \"read\")))";
	...
	public static void addRemainingPermissionsToRemainingDocsAsAdmin() {
		executeAdHocQueryAsAdmin(TestHelper.ADD_REMAINING_PERMISSIONS_TO_REMAINING_DOCS);
	}
}
